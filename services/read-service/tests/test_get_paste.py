...
async def test_non_existent(api_get_paste_expect_none, mongo_collection):
    paste_id = 'abc123'
...
async def test_expired(api_get_paste_expect_none, raw_insert_paste, mongo_collection):
    paste_id = 'abc123'
    paste_text = 'abc'
